...
As part of your incident analysis, address the following points:

- Determine the IP address assigned to that infected device.
- Determine where the file was downloaded from.
- Capture the flag.
- List the attacker's IP.
- Write an incident report of what happened.
